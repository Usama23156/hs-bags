...
type ButtonVariant = "primary" | "secondary" | "subscribe" | "ghost";
...
const variantStyles: Record<ButtonVariant, string> = {
  ...
  secondary:
    "border border-charcoal text-charcoal px-4 py-2 text-sm hover:bg-charcoal hover:text-white transition-colors",
  subscribe:
